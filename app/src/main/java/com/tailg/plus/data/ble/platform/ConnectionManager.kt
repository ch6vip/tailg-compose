...
/** Port of Dart `enum ConnectionState` (see class KDoc for LoginStatus mapping). */
 ...
 */
private class QueuedGattOperation<T>(
...
/** Thrown for failed GATT operations; [status] is the Android `BluetoothGatt` status code. */
private class GattException(val status: Int, message: String) : Exception(message)
